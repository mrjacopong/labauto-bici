	...
	*******************************************************************************/
	...
	NOTA: sono dichiarate 3 variabili per tipo, perchè la libreria originale era per tre motori
	Per la Self Balancing Bycicle ci bastano 2 variabili di ciascun tipo*/
    float vettore_Vout_1[length];   //vettore di uscita per ogni sensore
	...
	* Return value : none
	*******************************************************************************/
	void ADb10_init (void)  //Inizializza ADb10
	{
	...
	***********************************************************************************************/
	float ADb10_read (int sens_channel)
	    ...
	    case 1:
					...
					break;
		case 2:
					read_register = ((AD.ADDRE*VMAX)/MAX_COUNT); /*legge il risultato del registro per la porta AN4
	     			...
	     			break;
		case 3:
					read_register = ((AD.ADDRF*VMAX)/MAX_COUNT); /*legge il risultato del registro per la porta AN5
