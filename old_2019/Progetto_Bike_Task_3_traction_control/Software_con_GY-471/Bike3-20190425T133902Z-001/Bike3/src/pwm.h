...
/* Struttura per consentire l'uso di due motori differenti
 * con entrabi funzioni diverse: nel nostro caso un motore di trazione
 * e un motore per la gestione del manubrio
 */
typedef struct
{
	float volt_signal;
...
Macro definitions
*******************************************************************************/
#define V_MAX		12.0		/* massimo voltaggio per i nostri motori */
