...
#elif defined EMPL_TARGET_RENESAS
...
/**
 * EDIT by Sebastian Giles @ LabAut UNIVPM: disable sleep mode first
...
int mpu_set_bypass(unsigned char bypass_on)
{
    ...
    if (bypass_on) {
        ...
        //Start of code added by Sebastian Giles

        // read power management register
        if (i2c_read(st.hw->addr, st.reg->pwr_mgmt_1, 1, &tmp))
        	return -1;
        ...
        //End of code added by Sebastian Giles
