...
*         : 27.12.2018     1.00        First release
* Author: Mirko Bucella, Daniele Polucci
*******************************************************************************/
/* standard types */
#include <stdint.h>
#include <stdbool.h>
...
* Argomenti    : Numero del canale (unsigned char, float, Motor*)
...
/**********************************************************************************
* Nome funzione: DutyCycle_to_Motor
* Descrizione  : Settaggio del duty cycle mediante l'utilizzo delle funzioni di
* 				 calcolo descritte in precedenza
* Argomenti    : Puntatori a float che puntano i valori di uscita del PID presenti
* 				 nelle strutture, vengono passate tutte e tre le uscite insieme
* 				 (Motor*)
* Valore di ritorno : void
**********************************************************************************/
...
/**********************************************************************************
* Nome funzione: motor_direction
* Descrizione  : Settaggio della direzione e della tensione da inviare ai motori,
* 				 La tensione è in valore assoluto perché la direzione viene gestita
* 				 dalla variabile val
* Argomenti    : Valore della tensione e della direzione
* 				 Vengono passati tramite puntatori (Motor*)
* Valore di ritorno : void
**********************************************************************************/
